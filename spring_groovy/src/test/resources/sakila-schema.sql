...
CREATE CACHED TABLE "PUBLIC"."ACTOR"(
    "ACTOR_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."ADDRESS"(
    "ADDRESS_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."CATEGORY"(
    "CATEGORY_ID" TINYINT GENERATED BY DEFAULT AS IDENTITY(START WITH 100) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."COUNTRY"(
    "COUNTRY_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."LANGUAGE"(
    "LANGUAGE_ID" TINYINT GENERATED BY DEFAULT AS IDENTITY(START WITH 100) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."CITY"(
    "CITY_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."CUSTOMER"(
    "CUSTOMER_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."FILM"(
    "FILM_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1001) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."STORE"(
    "STORE_ID" TINYINT GENERATED BY DEFAULT AS IDENTITY(START WITH 100) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."INVENTORY"(
    "INVENTORY_ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 20000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."STAFF"(
    "STAFF_ID" TINYINT GENERATED BY DEFAULT AS IDENTITY(START WITH 100) NOT NULL,
    "FIRST_NAME" VARCHAR(45) NOT NULL,
    "LAST_NAME" VARCHAR(45) NOT NULL,
    "ADDRESS_ID" SMALLINT NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."RENTAL"(
    "RENTAL_ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 20000) NOT NULL,
...
CREATE CACHED TABLE "PUBLIC"."PAYMENT"(
    "PAYMENT_ID" SMALLINT GENERATED BY DEFAULT AS IDENTITY(START WITH 20000) NOT NULL,
    "CUSTOMER_ID" SMALLINT NOT NULL,
    "STAFF_ID" TINYINT NOT NULL,
    "RENTAL_ID" INTEGER,
